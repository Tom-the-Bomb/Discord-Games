...
class BattleShip:
    ...
    async def get_file(self, player: discord.User, *, hide: bool = True) -> tuple[discord.Embed, discord.File, discord.Embed, discord.File]:
    ...
    async def get_ship_inputs(self, ctx: commands.Context[commands.Bot], user: discord.User) -> bool:
