...
class TypeRacer:
    ...
    async def wait_for_tr_response(self, ctx: commands.Context, text: str, *, timeout: int) -> discord.Message:
            ...
            try:
                ...
                if winners:
                    ...
                    return await ctx.reply(
                        "Looks like no one responded", allowed_mentions=discord.AllowedMentions.none()
                    )
        ...
        embed = discord.Embed(title="Typerace results", color=self.embed_color, timestamp=dt.utcnow())
    ...
    async def start(
        ...
        *,
        ...
        embed = discord.Embed(title=embed_title, color=self.embed_color, timestamp=dt.utcnow())
        ...
        self._embed = embed
        self._message = await ctx.send(embed=embed, file=discord.File(buffer, "tr.png"))
